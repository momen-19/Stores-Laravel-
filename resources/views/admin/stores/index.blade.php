            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class="container-fluid col-md-6 mt-3">
                        <form class="d-flex" action="{{ route('search-admin') }}">
                            <input name="query" class="form-control me-3" type="search" placeholder="Search" aria-label="Search">
                            <button class="btn bg-gradient-primary w-55 mb-0 toast-btn" type="submit">Search</button>
                        </form>
                    </div>
                                ...
                                @foreach($stores as $store)
                                    ...
                                    <tr style="text-align: center">
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <div class="d-flex px-5">
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">{{ $store->category_id }}</h6>
                                                </div>
                                            </div>
                                            </p>
                                        </td>
                                        <td style="text-align: center">
                                            ...
                                            <div class="d-flex px-5">
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">{{ $store->mobile }}</h6>
                                                </div>
                                            </div>
                                            </p>
                                        </td>
