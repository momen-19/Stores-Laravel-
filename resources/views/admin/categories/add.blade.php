        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2 momen-1">
                    ...
                    @endif
                    <form class="row g-3 needs-validation" method="post" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-4">
                            <label for="validationCustom01" class="form-label">Name Categories</label>
                            <input type="text" name="name" class="form-control momen" placeholder="Name Categories" id="validationCustom01" required>
                        </div>
                        <div class="col-md-4">
